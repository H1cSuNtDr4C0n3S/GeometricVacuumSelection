...
Accordingly, statements of formal certification should be read as:
Lean certifies the analytic pipeline from the explicit coordinate form of $K^2$
and the adopted proxy-domain IR construction.
